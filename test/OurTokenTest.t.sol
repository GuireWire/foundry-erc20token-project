...
contract OurTokenTest is StdCheats, Test {
    ...
    function testAllowancesWorks() public {
        ...
        //Alice will take tokens from Bob because Bob allowed her to do so by approving
        uint256 transferAmount = 500;

        vm.prank(alice);
        ourToken.transferFrom(bob, alice, transferAmount); //this transfers from bob to alice with the amount being 500
